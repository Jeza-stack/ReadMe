...
export default function QuickAssessment() {
  ...
  if (currentSection === 'intro') {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-transparent px-2 sm:px-4 py-4 sm:py-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex justify-center mb-4 sm:mb-6">
              <Target className="w-12 h-12 sm:w-16 sm:h-16 text-blue-600 dark:text-cyan-400" />
            </div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-900 dark:text-white mb-3 sm:mb-4">
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm sm:text-base text-gray-800 dark:text-gray-200">Your estimated CEFR level (A1-C2)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 dark:text-green-400 mt-0.5 flex-shrink-0" />
                    <span className="text-sm sm:text-base text-gray-800 dark:text-gray-200">Detailed feedback on your performance</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 dark:text-green-400 mt-0.5 flex-shrink-0" />
                    <span className="text-sm sm:text-base text-gray-800 dark:text-gray-200">Personalized learning recommendations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 dark:text-green-400 mt-0.5 flex-shrink-0" />
                    <span className="text-sm sm:text-base text-gray-800 dark:text-gray-200">Immediate results and progress tracking</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-500/10 rounded-lg">
                    <span className="font-medium text-sm sm:text-base text-gray-900 dark:text-white">Grammar Questions</span>
                  ...
                  <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-500/10 rounded-lg">
                    <span className="font-medium text-sm sm:text-base text-gray-900 dark:text-white">Vocabulary Questions</span>
                    <Badge variant="secondary">8 questions</Badge>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-purple-50 dark:bg-purple-500/10 rounded-lg">
                    <span className="font-medium text-sm sm:text-base text-gray-900 dark:text-white">Reading Comprehension</span>
          ...
          <Card className="text-center">
            <CardContent className="p-6 sm:p-8">
              <Award className="w-12 h-12 sm:w-16 sm:h-16 text-blue-600 dark:text-cyan-400 mx-auto mb-4 sm:mb-6" />
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">Ready to Start?</h2>
  ...
  if (currentSection === 'test') {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-transparent px-2 sm:px-4 py-4 sm:py-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-white/[0.06] dark:border dark:border-white/10 rounded-lg sm:rounded-xl shadow-lg dark:backdrop-blur-xl p-4 sm:p-6 lg:p-8">
            <div className="text-center mb-6 sm:mb-8">
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">
                Quick Assessment
              </h1>
              <div className="flex justify-center items-center gap-2 text-gray-600 dark:text-gray-300">
            ...
            <Card className="mb-8 sm:mb-10">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl text-blue-700 dark:text-cyan-400">Reading Texts</CardTitle>
                <p className="text-sm text-gray-600 dark:text-gray-300">Read these texts carefully. You'll answer questions about them later.</p>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="bg-blue-50 dark:bg-blue-500/10 p-4 sm:p-6 rounded-lg border-l-4 border-blue-500">
                  <h4 className="font-bold text-blue-800 dark:text-blue-300 mb-3">Text 1: Daily Routine (A1)</h4>
                ...
                <div className="bg-green-50 dark:bg-green-500/10 p-4 sm:p-6 rounded-lg border-l-4 border-green-500">
                  <h4 className="font-bold text-green-800 dark:text-green-300 mb-3">Text 2: Climate Change (B1/B2)</h4>
                  <p className="text-gray-800 dark:text-gray-200 text-sm sm:text-base leading-relaxed">
              ...
              {['Grammar', 'Vocabulary', 'Reading'].map(category => (
                <Card key={category} className="border-2">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-lg sm:text-xl text-blue-700 dark:text-cyan-400">
                      {category} Questions
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    {questions
                      ...
                      .map((question, index) => (
                        <div key={question.id} className="bg-gray-50 dark:bg-white/5 p-4 sm:p-5 rounded-lg border dark:border-white/10">
                          ...
                          {question.type === 'radio' && question.options ? (
                            <div className="space-y-2">
                              {question.options.map((option, optIndex) => (
                                <label key={optIndex} className="flex items-center gap-3 cursor-pointer p-2 rounded hover:bg-blue-50 dark:hover:bg-white/10 transition-colors">
                                  <input
                                    type="radio"
                                    name={question.id}
                                    value={option}
                            ...
                            <input
                              ...
                              className="w-full max-w-xs border-2 border-gray-300 dark:border-white/20 dark:bg-white/5 dark:text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-sm sm:text-base"
                              onChange={(e) => handleInputChange(question.id, e.target.value)}
                            />
                          )}
                        </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-transparent px-2 sm:px-4 py-4 sm:py-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-white/[0.06] dark:border dark:border-white/10 rounded-lg sm:rounded-xl shadow-lg dark:backdrop-blur-xl p-4 sm:p-6 lg:p-8">
            <div className="text-center mb-8 sm:mb-12">
              <Award className="w-16 h-16 sm:w-20 sm:h-20 text-blue-600 dark:text-cyan-400 mx-auto mb-4 sm:mb-6" />
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
              <Card className={`border-4 ${cefrLevel?.color} text-center`}>
                <CardContent className="p-6 sm:p-8">
                  <div className="text-4xl sm:text-6xl font-black text-gray-900 dark:text-white mb-2">
                    {score}/20
                  </div>
                  <div className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-4">
                    Questions Correct
                  </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg sm:text-xl text-gray-900 dark:text-white">Performance Summary</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm sm:text-base font-medium text-gray-800 dark:text-gray-200">Time Spent:</span>
                    <span className="font-bold text-blue-600 dark:text-cyan-400">{timeSpent}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm sm:text-base font-medium text-gray-800 dark:text-gray-200">Accuracy:</span>
                    <span className="font-bold text-green-600 dark:text-green-400">{Math.round((score/20)*100)}%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm sm:text-base font-medium text-gray-800 dark:text-gray-200">Level:</span>
                    <span className="font-bold text-purple-600 dark:text-purple-400">{cefrLevel?.level}</span>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="mb-8 sm:mb-12">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl text-gray-900 dark:text-white">Your Feedback & Next Steps</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="bg-blue-50 dark:bg-blue-500/10 p-4 sm:p-6 rounded-lg border-l-4 border-blue-500 mb-6">
                  <p className="text-gray-800 dark:text-gray-200 text-sm sm:text-base leading-relaxed">
                    {cefrLevel?.feedback}
                  </p>
                </div>
                <div className="text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-4">
                  <strong className="text-gray-900 dark:text-white">Level Description:</strong> {cefrLevel?.description}
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8 sm:mb-12">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl text-gray-900 dark:text-white">Detailed Breakdown by Category</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
                  {['Grammar', 'Vocabulary', 'Reading'].map(category => {
                    ...
                    return (
                      <div key={category} className="text-center p-4 bg-gray-50 dark:bg-white/5 rounded-lg">
                        <h4 className="font-bold text-gray-900 dark:text-white mb-2 text-sm sm:text-base">{category}</h4>
                        <div className="text-2xl sm:text-3xl font-bold text-blue-600 dark:text-cyan-400 mb-1">
