...
export default function A1Lesson3ToDo() {
  ...
  const questions = [
    { id: 'q1_do', question: '1. I ____ like milk.' },
    { id: 'q2_do', question: '2. ____ she work on Sundays?' },
    { id: 'q3_do', question: '3. They ____ speak English very well.' },
    { id: 'q4_do', question: '4. He ____ watch TV in the morning.' },
    { id: 'q5_do', question: '5. ____ you live in a big city?' },
    { id: 'q6_do', question: '6. My brother ____ play video games.' },
    { id: 'q7_do', question: '7. We ____ go to school on holidays.' }
  ];
        ...
        <div className="bg-white rounded-lg sm:rounded-xl shadow-lg sm:shadow-xl p-4 sm:p-6 lg:p-8">
          ...
          <section className="mb-8 sm:mb-10">
            ...
            <ul className="list-disc ml-4 sm:ml-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-gray-900 text-sm sm:text-base lg:text-lg">
              <li><span className="font-bold text-blue-600">Form negative sentences.</span></li>
              <li><span className="font-bold text-blue-600">Form questions.</span></li>
            </ul>
          ...
          <section className="mb-8 sm:mb-10">
            ...
            <p className="mb-4 sm:mb-6 text-gray-900 text-sm sm:text-base lg:text-lg font-medium">
              To make a sentence negative in the Present Simple (for most verbs), we add <strong className="text-red-600">'do not'</strong> or <strong className="text-red-600">'does not'</strong> before the main verb.
            </p>
              ...
              <table className="w-full min-w-[700px] border-collapse bg-white rounded-lg overflow-hidden shadow-lg border-2 border-gray-300">
                ...
                <tbody>
                  <tr className="bg-gray-50">
                    ...
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-semibold">I do not work</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">I don't work</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium">I <strong>don't work</strong> on Saturdays.<br/>I <strong>don't like</strong> coffee.</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-gray-900 text-sm sm:text-base">You</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-semibold">You do not speak</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">You don't speak</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium">You <strong>don't speak</strong> French.<br/>You <strong>don't live</strong> here.</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-gray-900 text-sm sm:text-base">He</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-semibold">He does not play</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">He doesn't play</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium">He <strong>doesn't play</strong> football.<br/>He <strong>doesn't eat</strong> meat.</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-gray-900 text-sm sm:text-base">She</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-semibold">She does not cook</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">She doesn't cook</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium">She <strong>doesn't cook</strong> dinner every day.<br/>She <strong>doesn't watch</strong> TV.</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-gray-900 text-sm sm:text-base">It</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-semibold">It does not rain</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">It doesn't rain</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium">It <strong>doesn't rain</strong> much in summer.</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-gray-900 text-sm sm:text-base">We</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-semibold">We do not go</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">We don't go</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium">We <strong>don't go</strong> to bed late.<br/>We <strong>don't have</strong> class today.</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-gray-900 text-sm sm:text-base">They</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-semibold">They do not read</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">They don't read</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium">They <strong>don't read</strong> books.<br/>They <strong>don't live</strong> in a big city.</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-yellow-100 border-l-4 border-yellow-500 p-3 sm:p-4 rounded text-sm sm:text-base">
              <p className="text-gray-900 font-medium">
                <strong className="text-blue-700 font-bold">Important:</strong> When you use 'do not' or 'does not', the main verb always stays in its <strong className="text-red-600">base form</strong> (e.g., 'work', 'speak', 'play'). Do NOT add '-s' or '-es' to the main verb for 'he, she, it'!
              </p>
            </div>
          </section>
          ...
          <section className="mb-8 sm:mb-10">
            ...
            <p className="mb-4 sm:mb-6 text-gray-900 text-sm sm:text-base lg:text-lg font-medium">
              To ask a question in the Present Simple (for most verbs), we put <strong className="text-red-600">'Do'</strong> or <strong className="text-red-600">'Does'</strong> at the beginning of the sentence, before the subject.
            </p>
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full min-w-[700px] border-collapse bg-white rounded-lg overflow-hidden shadow-lg border-2 border-gray-300">
                ...
                <tbody>
                  <tr className="bg-gray-50">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">Do I...?</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium"><strong>Do I</strong> need to go?</td>
                  ...
                  <tr className="bg-white">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">Do you...?</td>
                  ...
                  <tr className="bg-gray-50">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">Does he...?</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium"><strong>Does he</strong> play sports?</td>
                  ...
                  <tr className="bg-white">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">Does she...?</td>
                  ...
                  <tr className="bg-gray-50">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">Does it...?</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium"><strong>Does it</strong> work?</td>
                  ...
                  <tr className="bg-white">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">Do we...?</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium"><strong>Do we</strong> have class today?</td>
                  ...
                  <tr className="bg-gray-50">
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 font-bold text-blue-600 text-xs sm:text-sm">Do they...?</td>
                    <td className="border-2 border-gray-300 px-2 sm:px-4 py-2 sm:py-3 text-gray-900 text-xs sm:text-sm font-medium"><strong>Do they</strong> live here?</td>
            ...
            <div className="bg-yellow-100 border-l-4 border-yellow-500 p-3 sm:p-4 rounded text-sm sm:text-base">
              <p className="text-gray-900 font-medium">
                <strong className="text-blue-700 font-bold">Remember:</strong> We use <strong className="text-red-600">'Does'</strong> for 'he, she, it' and <strong className="text-red-600">'Do'</strong> for 'I, you, we, they'. The main verb is always in its <strong>base form</strong> in questions!
              </p>
            </div>
          </section>
                  ...
                  return (
                    <div key={item.id} className="space-y-2">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        <span className="text-gray-900 font-bold text-sm sm:text-base lg:text-lg min-w-0 sm:min-w-[240px]">
                          {item.question}
                        </span>
