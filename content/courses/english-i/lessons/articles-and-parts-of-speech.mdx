...
quiz:
  ...
  - question: When should the indefinite article 'an' be used instead of 'a'?
    options:
      - Before words starting with a vowel sound
      - Before all long words
      - Before specific nouns
      - Before plural nouns
    correctAnswer: Before words starting with a vowel sound
    explanation: >-
      'A' is used before consonant sounds and 'an' before vowel sounds, as in
      'an apple'.
  - question: 'In the sentence ''I saw the cat that lives next door'', why is ''the'' used?'
    options:
      - Both speaker and listener know the specific cat
      - Any cat could be meant
      - Cats always take 'the'
      - '''The'' is used after verbs'
    correctAnswer: Both speaker and listener know the specific cat
    explanation: >-
      The definite article 'the' is used for a specific noun that both the
      speaker and listener know.
  - question: >-
      Which part of speech joins words or phrases, such as 'and', 'but', and
      'or'?
    options:
      - Conjunction
      - Preposition
    ...
    explanation: >-
      A conjunction is 'a word that joins words or phrases (e.g., and, but,
      or)'.
updated: '2026-07-04'
---
