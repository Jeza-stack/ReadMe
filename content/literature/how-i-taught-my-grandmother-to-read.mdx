...
quiz:
  - question: Why did the grandmother touch the author's feet?
    ...
    explanation: >-
      ...
      of knowledge.
  - question: >-
      Which serial story did the author read aloud to her grandmother every
      week?
    options:
      - '''Kashi Yatre'' by Triveni'
      - '''Karmaveera'' by Sudha Murthy'
      - '''Treasure Island'''
      - '''Tristram Shandy'''
    correctAnswer: '''Kashi Yatre'' by Triveni'
    explanation: >-
      Triveni's novel 'Kashi Yatre' was appearing as a serial in the Kannada
      weekly 'Karmaveera', and the girl read each episode to her grandmother.
  - question: >-
      Why was the grandmother in tears when the author returned from the
      wedding?
    options:
      - She could not read the new episode by herself
      - The magazine had stopped coming
      - She had lost her savings
      - The story had ended sadly
    correctAnswer: She could not read the new episode by herself
    explanation: >-
      The magazine came while the girl was away; the grandmother 'rubbed my
      hands over the pages, wishing I could understand what was written' and
      felt 'dependent and helpless.'
  - question: What deadline did the grandmother set for learning to read?
    options:
      - Saraswati Pooja day during Dussehra
      - Her sixty-third birthday
      - The next wedding season
      - New Year's Day
    correctAnswer: Saraswati Pooja day during Dussehra
    explanation: >-
      She decided: 'I will keep the Saraswati Pooja day during Dussehra as the
      deadline. That day I should be able to read a novel on my own.'
  - question: >-
      In the novel 'Kashi Yatre', what does the old woman finally do with her
      savings?
    options:
      - Gives them to an orphan girl for her wedding
      - Travels to Kashi
      - Builds a temple
      - Buys a house for her family
    correctAnswer: Gives them to an orphan girl for her wedding
    explanation: >-
      The old woman gives all her savings to the orphan girl, saying the girl's
      happiness 'is more important than worshipping Lord Vishweshwara at Kashi.'
  - question: Which statement best expresses the grandmother's belief about learning?
    options:
      - '''For learning, age is no bar'''
      - '''Education is only for the young'''
      - '''Money matters more than reading'''
      - '''Stories are a waste of time'''
    correctAnswer: '''For learning, age is no bar'''
    explanation: >-
      At sixty-two she declares: 'For a good cause, if you are determined, you
      can overcome any obstacle... For learning, age is no bar.'
updated: '2026-07-04'
---
